...
function Hero() {
  return (
    <div>
      <div className="w-[300px] h-[300px] my-4 mx-auto flex justify-center items-center rounded-full shadow-lg shadow-[#3c416b] shadow-offset-x-0  shadow-offset-y-0 shadow-blur-2">
